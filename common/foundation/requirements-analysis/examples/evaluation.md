...
Failure condition: Convert an ambiguous request into implementation assumptions silently.
...
Failure condition: Add process overhead when the desired change is already clear.

Validation: Confirm the local change remains direct and bounded.
