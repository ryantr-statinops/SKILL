...
Failure condition: Claim security without checking scope, trust boundaries, or abuse paths.
...
Failure condition: Generalize a narrow function review into a system-wide security claim.

Validation: Confirm scope and residual uncertainty are explicit.
