...
Failure condition: Load unrelated repository material or hide assumptions.
...
Failure condition: Expand context before identifying an information gap.

Validation: Confirm the task can proceed with the minimal relevant sources.
